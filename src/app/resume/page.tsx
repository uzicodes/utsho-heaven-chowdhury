    ...
    <div className="min-h-screen bg-[#0f1115] text-gray-200 font-sans selection:bg-[#F5BE27] selection:text-black">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="w-full flex justify-center">
          <div className="w-full max-w-5xl aspect-[1/1.4] sm:aspect-[4/3] md:aspect-[16/10] bg-[#0a0b0e] rounded-2xl overflow-hidden border border-gray-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.4)] ring-1 ring-white/5 p-1 sm:p-2 relative group">
