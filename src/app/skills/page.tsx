  ...
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Atlassian", icon: <img src="/icons/tools/atlassian.svg" alt="Atlassian" width={41} height={41} /> },
        { name: "Jest", icon: <img src="/icons/tools/jest.svg" alt="Jest" width={45} height={45}/> },
        { name: "Authjs", icon: <img src="/icons/tools/authjs.svg" alt="Authjs" width={40} height={40}/> },
        { name: "Postman", icon: <img src="/icons/tools/postman.svg" alt="Postman" width={45} height={45}/> },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Framer", icon: <img src="/icons/ui/framer.svg" alt="Framer" width={25} height={25} /> },
        { name: "Webflow", icon: <img src="/icons/ui/webflow.svg" alt="Webflow" width={43} height={43}/> },
