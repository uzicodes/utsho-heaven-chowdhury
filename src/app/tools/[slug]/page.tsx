...
export async function generateStaticParams() {
    return Object.keys(toolDetails).map((slug) => ({ slug }));
}

// Dynamic metadata per tool
export async function generateMetadata({ params }: ToolPageProps) {
    const resolvedParams = await params;
    const slug = resolvedParams.slug as ToolSlug;
    ...
    return {
        title: `${tool.title} | Utsho Heaven Chowdhury`,
        description: tool.shortDescription,
    };
}

export default async function ToolDetail({ params }: ToolPageProps) {
    const resolvedParams = await params;
    const slug = resolvedParams.slug as ToolSlug;
    const tool = toolDetails[slug];
    ...
    return (
        <ReactLenis root>
            <div className="min-h-screen bg-[#0f1115] text-gray-300 selection:bg-blue-500/30" style={{ fontFamily: 'var(--font-space-grotesk), sans-serif' }}>
                        ...
                        <div className="lg:col-span-2 space-y-16">
                            ...
                            <div>
                                ...
                                <div className="space-y-10 border-l-2 border-gray-800 pl-8 ml-3">
                                    {tool.developmentProcess.map((item, index) => (
                ...
                {tool.architecture && (
                    <section className="max-w-7xl mx-auto px-6 lg:px-12 pb-20">
                        ...
                        <div className="relative w-full max-w-4xl mx-auto flex justify-center items-center rounded-xl overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.5)] border border-gray-800 bg-[#0a0b0e] p-4 md:p-8">
                            <Image
                                src={tool.architecture.diagramUrl}
                                alt={`${tool.title} System Architecture`}
                                width={1200}
                                height={1200}
                ...
                {tool.featureSpotlight && tool.featureSpotlight.length > 0 && (
                    <section className="max-w-7xl mx-auto px-6 lg:px-12 pb-20">
                        <h2
                        ...
                        <FeatureSpotlight items={tool.featureSpotlight} />
                    </section>
                )}
                    ...
                    <div className="w-full max-w-7xl mx-auto text-center space-y-8">
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="flex justify-center gap-5">
                                {/* LinkedIn */}
                                <a href="https://www.linkedin.com/in/utshochowdhury/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#06CC2D] transition-colors" aria-label="LinkedIn">
