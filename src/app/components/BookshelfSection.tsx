...
const books: Book[] = [
  {
    ...
    title: "The Alchemist",
    author: "Paulo Coelho",
    cover: "/books/alchemist/cover.webp",
    spineColor: "bg-[url('/books/alchemist/spine.webp')] bg-cover bg-center",
  },
  {
    id: 2,
    title: "The Chronicles of Narnia",
    author: "C.S. Lewis",
    cover: "/books/narnia/cover.webp",
    spineColor: "bg-[url('/books/narnia/spine.webp')] bg-cover bg-center",
  },
  {
    id: 3,
    title: "Rich Dad Poor Dad",
    author: "Robert Kiyosaki",
    cover: "/books/rich/cover.webp",
    spineColor: "bg-[url('/books/rich/spine.webp')] bg-cover bg-center",
  },
  {
    id: 4,
    title: "To Kill a Mockingbird",
    author: "Harper Lee",
    cover: "/books/mockingbird/cover.webp",
    spineColor: "bg-[url('/books/mockingbird/spine.webp')] bg-cover bg-center",
  },
  {
    id: 5,
    title: "Abar tora Kipte Ho",
    author: "Anisul Haque",
    cover: "/books/kipte/cover.webp",
    spineColor: "bg-[url('/books/kipte/spine.webp')] bg-cover bg-center",
  },
  {
    id: 6,
    title: "The Let them theory",
    author: "Mel Robbins",
    cover: "/books/let/cover.webp",
    spineColor: "bg-[url('/books/let/spine.webp')] bg-cover bg-center",
  },
  {
    id: 7,
    title: "The 5 AM Club",
    author: "Robin Sharma",
    cover: "/books/5am/cover.webp",
    spineColor: "bg-[url('/books/5am/spine.webp')] bg-cover bg-center",
  },
];
